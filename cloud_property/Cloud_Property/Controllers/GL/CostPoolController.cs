...
namespace Cloud_Property.Controllers
{
    public class CostPoolController : AppController
    {
        ...
        public void Insert_COSTPOOLMST_LogData(PageModel model)
        {
            ...
            aslLog.LOGDATA = Convert.ToString("Group Cost Name: " + model.AGlCostPMST.COSTCNM + ".");
        ...
        public void Update_COSTPOOLMST_LogData(GL_COSTPMST model)
        {
            TimeZoneInfo timeZoneInfo;
            timeZoneInfo = TimeZoneInfo.FindSystemTimeZoneById("Central Asia Standard Time");
            DateTime PrintDate = TimeZoneInfo.ConvertTime(DateTime.Now, timeZoneInfo);
            ...
            aslLog.TABLEID = "GL_COSTPMST";
            aslLog.LOGDATA = Convert.ToString("Group Cost Name: " + model.COSTCNM + ".");
        ...
        public void Delete_COSTPOOLMST_LogData(GL_COSTPMST model)
        {
            TimeZoneInfo timeZoneInfo;
            timeZoneInfo = TimeZoneInfo.FindSystemTimeZoneById("Central Asia Standard Time");
            DateTime PrintDate = TimeZoneInfo.ConvertTime(DateTime.Now, timeZoneInfo);
        ...
        public void Insert_GL_CostPool_LogData(PageModel model)
        {
            ...
            string costCName = "";
            var getCostCname = (from m in db.GLCostPMSTDbSet
                where m.COMPID == aslLog.COMPID && m.COSTCID == model.AGlCostPool.COSTCID
                select new {m.COSTCNM}).Distinct().ToList();
            foreach (var VARIABLE in getCostCname)
            {
                costCName = VARIABLE.COSTCNM;
            }

            aslLog.LOGDATA = Convert.ToString("Group Cost Name: " + costCName + ",\nCost Head Name: " + model.AGlCostPool.COSTPNM + ",\nCost SID: " + model.AGlCostPool.COSTPSID + ",\nRemarks: " + model.AGlCostPool.REMARKS + ".");
        ...
        public void Delete_GL_CostPool_LogData(GL_COSTPOOL model)
        {
            ...
            string costCName = "";
            var getCostCname = (from m in db.GLCostPMSTDbSet
                                where m.COMPID == aslLog.COMPID && m.COSTCID == model.COSTCID
                                select new { m.COSTCNM }).Distinct().ToList();
            foreach (var VARIABLE in getCostCname)
            {
                costCName = VARIABLE.COSTCNM;
        ...
        public void Delete_ASL_DELETE_COSTPOOLMST_LogData(GL_COSTPMST model)
        {
            TimeZoneInfo timeZoneInfo;
            timeZoneInfo = TimeZoneInfo.FindSystemTimeZoneById("Central Asia Standard Time");
            DateTime PrintDate = TimeZoneInfo.ConvertTime(DateTime.Now, timeZoneInfo);
            ...
            AslDelete.TABLEID = "GL_COSTPMST";
            AslDelete.DELDATA = Convert.ToString("Group Cost Name: " + model.COSTCNM + ".");
        ...
        public void Delete_ASL_Delete_GL_CostPool_LogData(GL_COSTPOOL model)
        {
            ...
            AslDelete.DELDATA = Convert.ToString("Group Cost Name: " + costCName + ",\nCost Head Name: " + model.COSTPNM + ",\nCost SID: " + model.COSTPSID + ",\nRemarks: " + model.REMARKS + ".");
            AslDelete.USERPC = model.USERPC;
            db.AslDeleteDbSet.Add(AslDelete);
        ...
        public ActionResult IndexPost(PageModel model, string command)
        {
            ...
            if (command == "Update Head")
            {
                ...
                return RedirectToAction("EditCostPoolList");
            ...
            if (command == "Update")
            {
                ...
                string costCName = "";
                var getCostCname = (from m in db.GLCostPMSTDbSet
                                    where m.COMPID == model.AGlCostPool.COMPID && m.COSTCID == model.AGlCostPMST.COSTCID
                                    select new { m.COSTCNM }).Distinct().ToList();
                foreach (var VARIABLE in getCostCname)
                {
                    costCName = VARIABLE.COSTCNM;
                ...
                foreach (GL_COSTPOOL a in query)
                {
                    ...
                    TempData["AccountLogData"] = Convert.ToString("Group Cost Name: " + costCName + ",\nCost Head Name: " + model.AGlCostPool.COSTPNM + ",\nCost SID: " + model.AGlCostPool.COSTPSID + ",\nRemarks: " + model.AGlCostPool.REMARKS + ".");
        ...
        public ActionResult EditCostPoolList()
        {
        ...
        //Get
        public ActionResult EditCostPoolHead(int id = 0)
        {
            //.........................................................Update Permission Check
            var LoggedCompId = System.Web.HttpContext.Current.Session["loggedCompID"].ToString();
            var loggedUserID = System.Web.HttpContext.Current.Session["loggedUserID"].ToString();
        ...
        public ActionResult EditCostPoolHead(GL_COSTPMST costpoolhead, string Command)
        {
            if (Command == "Update")
            {
                if (ModelState.IsValid)
                {
                    ...
                    Update_COSTPOOLMST_LogData(costpoolhead);
                    db.SaveChanges();
        ...
        //Get
        public ActionResult DeleteCostPoolHead(int id = 0)
        {
        ...
        // POST: 
        [HttpPost, ActionName("DeleteCostPoolHead")]
        [ValidateAntiForgeryToken]
        public ActionResult DeleteAccountHeadConfirmed(int id, GL_COSTPMST CostHeadDelete, String Command)
        {
            if (Command == "Yes")
            {
                ...
                if (ifdataexistinChild.Count == 0)
                {
                    ...
                    Delete_COSTPOOLMST_LogData(costHead);
                    Delete_ASL_DELETE_COSTPOOLMST_LogData(costHead);
