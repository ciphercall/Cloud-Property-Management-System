...
namespace Cloud_Property.Controllers
{
    public class TrialBalanceController : AppController
    {
        ...
        public ActionResult RowWiseLinkPost(string DATE, Int64 COMPID, Int64 DEBITCD, string ACCOUNTNM)
        {
            GL_ACCHART model = new GL_ACCHART();
            
            model.USERPC = Convert.ToString(DATE); // Userpc used because string type datatime field not hold this model.
            model.COMPID = COMPID;
